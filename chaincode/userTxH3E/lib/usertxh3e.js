...
class UserTxH3E extends Contract {
    ...
    async insertUserTx(ctx,i,user_id,tx_id,merchant,transferType,quantity) {
        ...
        while (true) {
            ...
            if (res.done) {
                ...
                //0이면 내부 1이면 외부
                var infoJson={transferType:transferType,tx_id:tx_id,merchant:merchant,symbol:"h3c",quantity:quantity}
